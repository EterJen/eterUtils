...
class MyCommandRunner implements CommandLineRunner {
    ...
    public void run(String... args) {
        try {
            Runtime.getRuntime().exec("firefox http://172.17.12.1:8083/jyjcms/chunkUpload.html");
//            Runtime.getRuntime().exec("firefox http://172.17.12.1:8083/jyjcms/fileOperation/trustedRequest/processRequest?video=/bigFile/2020/07/09//094144640.mp4");
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
